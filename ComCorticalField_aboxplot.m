...
for ii=1:6
  ...
  ylabel('% Variance explained')
    ...
    elseif ii==1
        ...
        box off
    elseif ii==4
        title('Space-F0','FontSize',14)
        set(gca,'XTick',1:1:4)
        set(gca,'XTickLabel',{'A1', 'AAF','PPF','PSF'})
        set(gca,'Ylim',[-.07 0.15]*100);
        set(gca,'FontSize',fns,'linewidth',1.1,'FontWeight','bold')
        box off
    elseif ii==5
        title('Space-Timbre','FontSize',14)
        set(gca,'XTick',1:1:4)
        set(gca,'XTickLabel',{'A1', 'AAF','PPF','PSF'})
        set(gca,'Ylim',[-.09 0.20]*100);
        set(gca,'FontSize',fns,'linewidth',1.1,'FontWeight','bold')
        box off
    elseif ii==6
       title('F0-Timbre','FontSize',14)
        set(gca,'XTick',1:1:4)
        set(gca,'XTickLabel',{'A1', 'AAF','PPF','PSF'})
